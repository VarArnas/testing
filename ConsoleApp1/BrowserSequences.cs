...
public sealed class BrowserSequences
{
    ...
    public void lab2()
    {
        ...
        IWebElement recipient = _driver.FindElement(By.XPath("//input[@class='recipient-name']"));
        recipient.SendKeys("gaga");

        IWebElement yours = _driver.FindElement(By.XPath("//input[@class='sender-name']"));
        yours.SendKeys("lala");

        IWebElement qty = _driver.FindElement(By.XPath("//div[@class='add-to-cart-panel']/descendant::input[@type='text']"));
        qty.Clear();
        qty.SendKeys("5000");
        ...
        IWebElement jewelryQty = _driver.FindElement(By.XPath("//div[@class='add-to-cart-panel']/input[@type='text']"));
        jewelryQty.Clear();
        jewelryQty.SendKeys("26");

        IWebElement jewelryCart = _driver.FindElement(By.XPath("//div[@class='add-to-cart-panel']/input[@type='button'][1]"));
        jewelryCart.Click();

        IWebElement jewelryWish = _wait.Until(d =>
        {
            var element = d.FindElement(By.XPath("//div[@class='ajax-loading-block-window']"));
            return !element.Displayed ? d.FindElement(By.XPath("//div[@class='add-to-cart-panel']/input[@type='button'][2]")) : null;
        });
        jewelryWish.Click();
        ...
        {
            var element = d.FindElement(By.XPath("//div[@class='ajax-loading-block-window']"));
            return !element.Displayed ? d.FindElement(By.XPath("//a[@href='/wishlist'][@class='ico-wishlist']")) : null;
        });
        wishlist.Click();

        IReadOnlyCollection<IWebElement> addingToCart = _driver.FindElements(By.XPath("//input[@type='checkbox'][@name='addtocart']"));
        ...
        IWebElement finalPrice = _driver.FindElement(By.XPath("//span[@class='product-price order-total']/strong"));
